 ...
 */
public class BaseResourceJsonIgnoreLinks<PK extends Serializable> extends BaseResource<PK> {

	private static final long serialVersionUID = 1L;

	public BaseResourceJsonIgnoreLinks() {
		super();
	}

	public BaseResourceJsonIgnoreLinks(BaseResource<PK> dto) {
		super(dto);
	}
